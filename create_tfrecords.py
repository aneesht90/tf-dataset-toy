...
def create(data, mask_dir, mask_suffix, output_dir, output_name, num_shards, num_threads):
    ...
    for thread_index in range(1, num_threads + 1):
        ...
        args = (thread_index, batch_data, shards, num_shards, mask_dir, mask_suffix, output_dir, output_name,
                error_queue)
